...
import TempleDeathAnniversaryTable from "@/components/Organisms/TempleDeathAnniversaryTable";
import { EDeathAnniversaryStatus } from "@/graphql/generated/schema";
import useTrans from "@/hooks/useTrans";
import { Tabs, TabsProps } from "antd";
import { useState } from "react";

const TempleListDeathAnniversary = () => {
  ...
  return (
    <div>
      ...
      <TempleDeathAnniversaryTable status={status} />
    </div>
  );
};

export default TempleListDeathAnniversary;
